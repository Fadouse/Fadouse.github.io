...
1. **abate** v. 减轻，降价
   ...
   :star:a(加强) + bate(减弱，减少) 

   :information_source: ​This action can't ***abate*** his bad habits.

2. **abhorrent** adj. 可恶的，可恨的

   :star:ab(加强) + horr(发抖) + ent(形容词后缀)

   :information_source: ​Ever since he started stealing, He's been ***abhorrent***.

3. **abide** v. 遵守，逗留；容忍，忍受

   :star:a (加强)+ bide(停留)

   :information_source: ​We need to ***abide*** the law, else we will be punished.

4. **abode*** n. 房屋，家

   :star:right of abode 居住权; fixed abode 固定住所

   :information_source: ​I enjoy to living in my small but cozy ***abode***.

5. **abound***  vi. 丰富，充满

   :star:a(一个) + bound(界限，范围) :arrow_right:  所有物品都在一个区:arrow_right:域内  丰富，充满

   :information_source: ​My computer drive is ***abound*** with galgame.

6. **absenteeism*** n. 旷课；旷工

   :star:absent + ee(代表人) + ism :arrow_right: 旷课；旷工

   :information_source: ​The China company dislike their sutff have ***absenteeism***, because it will dcrease the productivity.

7. **absolute*** adj. 完全的，绝对的，纯粹的

   :star:ab(加强) + solut(松开) + e :arrow_right: 完全松开 :arrow_right: 完全的，信任的

   :information_source: ​Your answer was ***absolute*** incorrect.

8. **absorb*** v. 吸收；吸引...的注意，使全神贯注

   :star:ab(离去) + sorb(吸收) + :arrow_right: 吸掉 :arrow_right: 吸收

   :information_source: ​He ***absorb*** teacher attention by shout the correct answer out.

9. **abstract*** adj. 抽象的

   :star:abs + tract :arrow_right: 抽象化

   :information_source: ​The extand math is partly ***abstract***.
...
11. **abundance*** n. 大量，丰富，充足，充裕
    ...
    :star: 来自***abundant*** (adj. 丰富的，充裕的)

    :information_source: At the party, there was food and drink in ***abundance***.

12. **academic*** adj. 学院的；学术的；不切实际的；n. 学者；大学教授

    :information_source: The ***academic*** research what we are doing now will impact our GPA.

13. **accelerate** v. 加速；促进

    :star: ac(=to) + celer(快速的) + ate(使...) :arrow_right: 加速；促进

    :information_source: He's ***accelerating*** our productivity.
